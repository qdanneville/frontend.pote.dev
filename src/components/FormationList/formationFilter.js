...
export const FormationFilter = ({ handleFormationsFilter }) => {
    ...
    const handleDifficultyFilter = (event) => {
        handleFormationsFilter({ difficulty: event.target.value, technology: selectedTechnology })
        setSelectedDifficulty(event.target.value)
    }

    const handleTechnologyFilter = (event) => {
        handleFormationsFilter({ technology: event.target.value, difficulty: selectedDifficulty })
